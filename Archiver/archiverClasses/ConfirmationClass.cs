...
namespace Archiver.archiverClasses
{
    class ConfirmationClass
    {
        ...
        public DataTable Select()
        {
            ...
            {
                // Query
                string sql = "SELECT Id, date, name, father_name, mother_name, first_godfather, second_godfather, state, municipality, notes, book_number, sheet_number, entry_number from tbl_confirmation";
