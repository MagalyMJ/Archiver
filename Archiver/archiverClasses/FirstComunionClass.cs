...
namespace Archiver.archiverClasses
{
    class FirstComunionClass
    {
        ...
        public DataTable Select(string options = " WHERE 1=1")
        {
            ...
            {
                // Query
                string sql = "SELECT Id, date, name, father_name, mother_name, first_godfather, second_godfather, state, rc, notes, book_number, sheet_number, entry_number from tbl_first_comunion" + options;
        ...
        public bool Insert(FirstComunionClass firstComunion)
        {
            ...
            {
                // Query
                string sql = "INSERT INTO tbl_first_comunion (date, name, father_name, mother_name, first_godfather, second_godfather, state, rc, notes, book_number, sheet_number, entry_number, created_at) VALUES (@date, @name, @father_name, @mother_name, @first_godfather, @second_godfather, @state, @rc, @notes, @book_number, @sheet_number, @entry_number, @created_at)";
                ...
                cmd.Parameters.AddWithValue("@rc", firstComunion.rc);
        ...
        public bool Update(FirstComunionClass firstComunion)
        {
            ...
            {
                // Query
                string sql = "UPDATE tbl_first_comunion SET date = @date, name = @name, father_name = @father_name, mother_name = @mother_name, first_godfather = @first_godfather, second_godfather = @second_godfather, state = @state, rc = @rc, notes = @notes, book_number = @book_number, sheet_number = @sheet_number, entry_number = @entry_number WHERE Id = @id";
